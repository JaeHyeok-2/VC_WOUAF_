...
def run_inference(args, gpu_num, gpu_no, **kwargs):
    ...
    model.first_stage_model = customize_vae_decoder(model.first_stage_model, 64, 16)
    
    with open("model_info_first_stage_model.txt", 'w') as f:
        print(model.first_stage_model, file=f)
